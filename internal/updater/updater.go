...
func New(dockerClient docker.DockerClient, registryClient registry.RegistryClient, notifier *notification.Notifier, cfg *config.Config, spec *policy.Spec, auditLog *audit.Log) *Updater {
	return &Updater{
		docker:   dockerClient,
